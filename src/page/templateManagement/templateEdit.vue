  ...
  <div id="templateAdd">
    ...
    <div style="margin-top:30px;">
      ...
      >
        ...
        <el-form-item :label="'模板编辑人'">
          <el-button v-if="isCreate" type="primary" @click="addOprate(2)"
            >添加模板编辑人</el-button
          >
    ...
    >
      ...
      >
        ...
        <el-form-item v-if="navigationForm.bgImg.length > 0" label>
    ...
    :style="{
     ...
     <div v-if="previewSave" slot="footer" style="text-align:center">
         <el-button :style="'width:11rem'" @click="previewCertificate=false"
        >取消</el-button
      >
         <el-button
        :style="'width:11rem'"
...
export default {
  ...
  methods: {
    ...
    listenKeyDown(e) {
      ...
      if (e.ctrlKey) {
        ...
        if (e.key == "c") {
          ...
          this.ctrlC = activeArr; //this.rects[this.$store.getters["getActive"]];
    ...
    deleterct() {
      ...
      let qrRect = actArr.find(item => item.type == "qrcode");
      if (qrRect) {
    ...
    async submitForm(e, formName, eventData) {
      ...
      // 将所有宽高，top ,left ,zindex 转为数字类型，兼容老数据
