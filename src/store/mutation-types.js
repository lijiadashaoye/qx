...
export const ADDRECTS = 'ADDRECTS';
export const DELETE_RECT = "DELETE_RECT";
export const RESET_LABELCOLOR = "RESET_LABELCOLOR";
export const RESET_LABELFONT = "RESET_LABELFONT";
export const GET_RECTS = "GET_RECTS";
export const GETPAGE_MODULESRECTS = "GETPAGE_MODULESRECTS";
export const SETACTIVE_MODULESSTATUS = "SETACTIVE_MODULESSTATUS";
export const SETMODULESCOM = "SETMODULESCOM";
export const SETMODULE_ATTR = "SETMODULE_ATTR";
export const SETCOM_ATTR = "SETCOM_ATTR";
export const SETZINDEX = "SETZINDEX";
export const SETZINDEXRECT = "SETZINDEXRECT";
export default {
    SETACTIVE_MODULESSTATUS,
    SETMODULESCOM,
    SETMODULE_ATTR,
    SETCOM_ATTR,
    GET_RECTS,
